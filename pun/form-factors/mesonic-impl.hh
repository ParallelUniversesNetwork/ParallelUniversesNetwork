...
#ifndef pun_GUARD_SRC_RARE_B_DECAYS_FORM_FACTORS_IMPL_HH
#define pun_GUARD_SRC_RARE_B_DECAYS_FORM_FACTORS_IMPL_HH 1

#include <pun/form-factors/mesonic.hh>
#include <pun/form-factors/mesonic-processes.hh>
#include <pun/form-factors/analytic-b-to-pi.hh>
#include <pun/form-factors/analytic-b-to-p-lcsr.hh>
#include <pun/form-factors/analytic-b-to-v-lcsr.hh>
#include <pun/maths/derivative.hh>
...
namespace pun
{
        ...
        public FormFactors<PToV>
    {
        ...
        public:
            ...
            virtual double a_12(const double & s) const
            {
                ...
                const double lambda = pun::lambda(mB2, mV2, s);
        ...
        public FormFactors<PToV>
    {
        ...
        public:
            ...
            virtual double a_2(const double & s) const
            {
                const double lambda = pun::lambda(_mB2, _mV2, s);
        ...
        private:
          ...
          public:
            ...
            virtual complex<double> f_perp(const double & q2, const double & k2, const double & ctheta) const
            {
                ...
                const double lambda = pun::lambda(q2, k2, mB2);
