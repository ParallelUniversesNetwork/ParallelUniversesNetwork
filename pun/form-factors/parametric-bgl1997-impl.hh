...
#ifndef pun_GUARD_pun_FORM_FACTORS_PARAMETRIC_BGL1997_IMPL_HH
#define pun_GUARD_pun_FORM_FACTORS_PARAMETRIC_BGL1997_IMPL_HH 1
...
namespace pun
{
    ...
    {
        return (_mB + _mV) / pun::lambda(_mB2, _mV2, s) * ((_mB2 - _mV2 - s) * f(s) - 2.0 * _mV * F1(s));
    }
