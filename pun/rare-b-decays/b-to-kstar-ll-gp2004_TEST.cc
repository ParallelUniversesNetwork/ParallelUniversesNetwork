...
//#define pun_GENERATE_TEST_DATA
#ifdef pun_GENERATE_TEST_DATA
    ...
    public TestCase
{
    public:
        ...
        virtual void run() const
        {
            ...
            std::string filename(pun_SRCDIR "/pun/rare-b-decays/exclusive-b-to-s-dilepton-low-recoil_TEST-btokstarll.data");
#ifdef pun_GENERATE_TEST_DATA
            {
