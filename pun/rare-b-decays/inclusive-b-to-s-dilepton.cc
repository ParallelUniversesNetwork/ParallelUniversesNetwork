...
#include <pun/rare-b-decays/bremsstrahlung.hh>
#include <pun/rare-b-decays/charm-loops.hh>
#include <pun/rare-b-decays/em-contributions.hh>
#include <pun/rare-b-decays/inclusive-b-to-s-dilepton.hh>
...
namespace pun
{
    ...
    struct Implementation<BToXsDilepton<HLMW2005>>
    {
        ...
        double phi_ll(const double & s) const
        {
             ...
             * For m_s != 0, pun provides c7',c8' != 0 in the "SM" model.
             */
            {
                /*
