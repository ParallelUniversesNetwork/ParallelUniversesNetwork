...
namespace pun
{
    ...
    struct Implementation<BToXsGamma<NLO>>
    {
        ...
        /*
         * Compute functions f_ij, cf. [CMM1996], p.9, Eq. (39) and below.
        ...
        inline std::array<complex<double>, 8> r_i(const double & z) const
        {
            ...
            // cf. [BCMU2002], Eqs. (3.8) and (3.9), pp. 4, 5
        ...
        // effective Wilson coefficients c7eff according to [CMM1996], p. 2, Eq. (5)
        ...
        // effective Wilson coefficient c8eff according to [CMM1996], p. 2, Eq. (5)
        inline complex<double> c8eff(const WilsonCoefficients<BToS> & wc) const
        {
            return wc.c8() + wc.c3() - wc.c4() / 6.0 + 20.0 * wc.c5() - 10.0 * wc.c6() / 3.0;
        }

        // D: perturbative b->sgamma contribution, cf. [CMM1996], p. 7, Eq. (31)
        inline complex<double> perturbative_bsgamma(const double & z, const WilsonCoefficients<BToS> & wc, const double & alpha_s, const double & lnmu) const
        {
            ...
            // Elements of the anomalous mass dimension gamma_i7, cf. [CMM1996], Eq. (8), p. 3
        ...
        // based on the results given in [CMM1996], p. 7, Eq. (31)
        ...
        // A: perturbative b->sgammagluon contribution, cf. [CMM1996], p. 7, Eq. (32)
        inline double perturbative_bsgammagluon(const double & z, const double & delta, const WilsonCoefficients<BToS> & wc, const double & alpha_s) const
        {
            ...
            // b->sgammagluon Bremstrahlung corrections, cf. [CMM1996], Eq. (32), p. 7
        ...
        double ratio_quark(const double & z, const double & delta, const double & ckm, const double & alpha_s, const double & mu) const
        {
            ...
            // phase space factors, cf. [CMM1996], between Eqs. (43) and (44), p. 10
            double g = phase_space_g(z), h = phase_space_h(z);

            // cf. [CMM1996], Eq. (43), p. 10
            double kappa = 1.0 - (2.0 * alpha_s * h) / (3.0 * pi * g);
            // cf. [CMM1996], Eq. (45), p. 10
            double F = (1.0 - (8.0 * alpha_s) / (3.0 * pi)) / kappa;
            // cf. [CMM1996], Eq. (30), p. 7
        ...
        double decay_rate(const double & emin) const
        {
            ...
            // Kinematics
            // Use m_c(mu) instead of m_c_pole, cf. [GM2001], pp. 2-3.
             ...
             * findings of [EGN2010], p. 10, eq. (3.17).
             *
             * The 1/m_b terms to leading order in alpha_s are not used, since they are
             * already included in the NLO calculation by [CMM1996].
             *
        ...
        Diagnostics diagnostics() const
        {
            ...
            // Functions f_ij, cf. [CMM1996], p. 9
            {
                // z = 0.22^2, delta = 1/6
                Fij f_ij = this->f_ij(0.22 * 0.22, std::log(0.22 * 0.22), 1.0 / 6.0);
                results.add(Diagnostics::Entry{ std::real(f_ij.f22), "Re(f_22(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f22), "Im(f_22(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f27), "Re(f_27(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f27), "Im(f_27(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f78), "Re(f_78(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f78), "Im(f_78(z = 0.22^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                // z = 0.29^2, delta = 1/6
                f_ij = this->f_ij(0.29 * 0.29, std::log(0.29 * 0.29), 1.0 / 6.0);
                results.add(Diagnostics::Entry{ std::real(f_ij.f22), "Re(f_22(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f22), "Im(f_22(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f27), "Re(f_27(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f27), "Im(f_27(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f78), "Re(f_78(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f78), "Im(f_78(z = 0.29^2, delta = 1/6)), [CMM1996], p. 9, Eq. (39)" });
                // z = 0.22^2, delta = 1/9
                f_ij = this->f_ij(0.22 * 0.22, std::log(0.22 * 0.22), 1.0 / 9.0);
                results.add(Diagnostics::Entry{ std::real(f_ij.f22), "Re(f_22(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f22), "Im(f_22(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f27), "Re(f_27(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f27), "Im(f_27(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f78), "Re(f_78(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f78), "Im(f_78(z = 0.22^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                // z = 0.29^2, delta = 1/9
                f_ij = this->f_ij(0.29 * 0.29, std::log(0.29 * 0.29), 1.0 / 9.0);
                results.add(Diagnostics::Entry{ std::real(f_ij.f22), "Re(f_22(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f22), "Im(f_22(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f27), "Re(f_27(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f27), "Im(f_27(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::real(f_ij.f78), "Re(f_78(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
                results.add(Diagnostics::Entry{ std::imag(f_ij.f78), "Im(f_78(z = 0.29^2, delta = 1/9)), [CMM1996], p. 9, Eq. (39)" });
            }

            // Function r_i, cf. [CMM1996], p. 8, Eqs. (33)-(36) and [BCMU2002], p. 3, Eq. (3.1).
            {
                // z = 0.22^2
                std::array<complex<double>, 8> r_i = this->r_i(0.22 * 0.22);
                results.add(Diagnostics::Entry{ std::real(r_i[0]), "Re(r_1(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[0]), "Im(r_1(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[1]), "Re(r_2(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[1]), "Im(r_2(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[2]), "Re(r_3(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[2]), "Im(r_3(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[3]), "Re(r_4(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[3]), "Im(r_4(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[4]), "Re(r_5(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[4]), "Im(r_5(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[5]), "Re(r_6(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[5]), "Im(r_6(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[6]), "Re(r_7(z = 0.22^2)), [CMM1996], p. 8, Eq. (36)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[6]), "Im(r_7(z = 0.22^2)), [CMM1996], p. 8, Eq. (36)" });
                results.add(Diagnostics::Entry{ std::real(r_i[7]), "Re(r_8(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[7]), "Im(r_8(z = 0.22^2)), [BCMU2002], p. 3, Eq. (3.1)" });

                // z = 0.29^2
                r_i = this->r_i(0.29 * 0.29);
                results.add(Diagnostics::Entry{ std::real(r_i[0]), "Re(r_1(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[0]), "Im(r_1(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[1]), "Re(r_2(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[1]), "Im(r_2(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[2]), "Re(r_3(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[2]), "Im(r_3(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[3]), "Re(r_4(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[3]), "Im(r_4(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[4]), "Re(r_5(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[4]), "Im(r_5(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[5]), "Re(r_6(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[5]), "Im(r_6(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::real(r_i[6]), "Re(r_7(z = 0.29^2)), [CMM1996], p. 8, Eq. (36)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[6]), "Im(r_7(z = 0.29^2)), [CMM1996], p. 8, Eq. (36)" });
                results.add(Diagnostics::Entry{ std::real(r_i[7]), "Re(r_8(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
                results.add(Diagnostics::Entry{ std::imag(r_i[7]), "Im(r_8(z = 0.29^2)), [BCMU2002], p. 3, Eq. (3.1)" });
            }

            // Phase space functions g and h, cf. [CMM1996], p. 10, Eqs. (42),(43)f
            {
                // g
