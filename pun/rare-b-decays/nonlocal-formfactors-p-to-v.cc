            ...
            public NonlocalFormFactor<nff::PToV>
        {
            ...
            public:
                                                      ...
                                                      const complex<double> & alpha_2) const
                {
                    ...
                    const auto zBV     = pun::nff_utils::z(pow(m_B + m_V, 2), s_p, s_0);
                    ...
                    return pun::nff_utils::PGvDV2020(z_Jpsi, zBV, alpha_0, alpha_1, alpha_2) / phi(m_Jpsi2, phiParam) *
                                                       ...
                                                       const complex<double> & alpha_2) const
                {
                    ...
                    return pun::nff_utils::PGvDV2020(z_psi2S, zBV, alpha_0, alpha_1, alpha_2) / phi(m_psi2S2, phiParam) *
                ...
                virtual complex<double> H_perp(const double & q2) const
                {
                    ...
                    return pun::nff_utils::PGvDV2020(z, zBV, alpha_0, alpha_1, alpha_2) / phi(q2, phiParam) / blaschke_factor;
                }
                ...
                virtual complex<double> Hhat_perp(const double & q2) const
                {
                    ...
                    return pun::nff_utils::PGvDV2020(z, zBV, alpha_0, alpha_1, alpha_2);
                }
                ...
                virtual complex<double> ratio_perp(const double & q2) const
                {
                    ...
                    const double lambda = pun::lambda(m_B2, m_V2, q2);
