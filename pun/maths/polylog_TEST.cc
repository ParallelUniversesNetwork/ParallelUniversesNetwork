    ...
    public TestCase
{
    public:
        ...
        {
            std::ifstream z_file(pun_SRCDIR "/pun/maths/polylog_TEST_z.bin");
            std::ifstream dilog_file(pun_SRCDIR "/pun/maths/polylog_TEST_dilog.bin");
            std::ifstream trilog_file(pun_SRCDIR "/pun/maths/polylog_TEST_trilog.bin");
