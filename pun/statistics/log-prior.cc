...
namespace pun
{
    ...
    {
        LogPriorPtr prior = std::make_shared<pun::priors::Flat>(parameters, name, range);
            ...
            const double & lower, const double & central, const double & upper)
    {
        ...
        LogPriorPtr prior = std::make_shared<pun::priors::Gauss>(parameters, name, range, lower, central, upper);
            ...
            const double & mu_0, const double & lambda)
    {
        ...
        LogPriorPtr prior = std::make_shared<pun::priors::Scale>(parameters, name, range, mu_0, lambda);
