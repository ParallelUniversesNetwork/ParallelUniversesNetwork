...
#ifndef pun_GUARD_SRC_STATISTICS_LIKELIHOOD_HH
#define pun_GUARD_SRC_STATISTICS_LIKELIHOOD_HH 1

#include <pun/constraint.hh>
#include <pun/observable.hh>
#include <pun/statistics/log-likelihood-fwd.hh>
#include <pun/statistics/test-statistic.hh>
#include <pun/maths/matrix.hh>
