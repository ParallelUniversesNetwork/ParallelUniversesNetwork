...
#ifdef pun_USE_GSL_LINALG_CHOLESKY_DECOMP
#  if (pun_USE_GSL_LINALG_CHOLESKY_DECOMP == 1)
...
#  endif
#else
#  error pun_USE_GSL_LINALG_CHOLESKY_DECOMP not defined.
#endif
