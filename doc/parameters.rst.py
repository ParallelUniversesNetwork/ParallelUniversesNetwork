...
def key(x):
    if type(x[0]) is pun.QualifiedName:
...
print('#' * len(page_title))
print('\n')
print('The following is the full list of parameters and their values used in pun v{}.\n\n'.format(pun.__version__))
