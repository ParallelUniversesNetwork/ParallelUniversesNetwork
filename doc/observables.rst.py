...
# Mirror the pun observables hierarchy as structured string data: arrays of
...
def make_doc_sections():
    return [{
        ...
        } for section in pun.Observables().sections()]
