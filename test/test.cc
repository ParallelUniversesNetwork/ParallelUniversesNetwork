...
namespace test
{
    ...
    // Use a small, local singleton in order to avoid linking against libpunutils
...
int main(int, char ** argv)
{
    ...
    pun::Log::instance()->set_program_name(program_name);
    pun::Log::instance()->set_log_level(pun::ll_debug);
