...
#ifndef pun_GUARD_SRC_CLIENTS_CLI_OPTION_HH
#define pun_GUARD_SRC_CLIENTS_CLI_OPTION_HH 1

#include <pun/utils/kinematic.hh>
#include <pun/utils/log.hh>
#include <pun/utils/named-value.hh>
#include <pun/utils/parameters.hh>
#include <pun/utils/private_implementation_pattern.hh>
#include <pun/utils/type-list.hh>
#include <pun/utils/visitor.hh>
...
namespace pun
{
    ...
    namespace cli
    {
        ...
        /**
         * The '--kinematic-variable' pun-specific command line argument.
         */
        ...
        /**
         * The '--parameter-budget' pun-specific command line argument.
         */
        class ParameterBudgetArg :
            public StringArg
        {
