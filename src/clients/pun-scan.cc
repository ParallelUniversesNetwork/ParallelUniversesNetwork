...
#include <pun/utils/cartesian-product.hh>
#include <pun/utils/destringify.hh>
#include <pun/utils/lock.hh>
#include <pun/utils/log.hh>
#include <pun/utils/mutex.hh>
#include <pun/utils/thread_pool.hh>
...
class WilsonScan
{
    public:
        ...
        void scan()
        {
            std::cout << "# Generated by pun-scan (" pun_GITHEAD ")" << std::endl;
...
main(int argc, char * argv[])
{
    try
    {
        ...
        Log::instance()->set_program_name("pun-scan");
    ...
    catch(DoUsage & e)
    {
        ...
        std::cout << "Usage: pun-scan" << std::endl;
